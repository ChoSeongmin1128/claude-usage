    ...
    XCTestCase
{
    func testDisplayBasisReprojectsWithoutQuotaRefreshSettingsWriteOrProcessRecovery() async {
        ...
        let changed = await fixture.controller.setUsageDisplayBasis(.remaining)
        ...
        let repeated = await fixture.controller.setUsageDisplayBasis(.remaining)
        ...
        let ignored = await fixture.controller.setUsageDisplayBasis(.used)

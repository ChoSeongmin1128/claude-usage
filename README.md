...
설정 → 일반 → 모션에서 즉시·부드러움·사용자 설정을 선택합니다. 사용자 설정에서는 팝오버 열기·닫기와 크기 전환, 설정 탭·빠른 시작 단계, 상세 접기·펼치기, 표시 항목 이동·숨기기, 사용량 막대 갱신을 각각 조정할 수 있습니다. 기본값은 즉시이며 macOS의 ‘동작 줄이기’를 우선합니다.

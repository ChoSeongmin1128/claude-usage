...
private extension APIError {
    var isHTTPResponseLike: Bool {
        ...
        case .invalidSessionKey, .rateLimited, .serverError:
            return true
        case .codexReauthRequired, .codexTokenRefreshTemporary, .claudeCodeCredentialUnavailable, .cloudflareBlocked, .networkError, .permissionDenied, .parseError, .unknownError:
            return false
        }
    }
}

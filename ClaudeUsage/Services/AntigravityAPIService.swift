...
private extension APIError {
    var isHTTPResponseLike: Bool {
        ...
        case .invalidSessionKey, .rateLimited, .serverError:
            return true
        case .codexReauthRequired, .codexTokenRefreshTemporary, .claudeCodeCredentialUnavailable, .claudeCodeReauthenticationRequired, .claudeCodeReconnectRequired, .cloudflareBlocked, .networkError, .permissionDenied, .parseError, .unknownError:
            return false
        }
    }
}
